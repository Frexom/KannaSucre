...
class AdminCog(commands.Cog):
    ...
    async def ban(self, context):
        ...
        if(hasMention):
            ...
            await context.send("```" + context.prefix + "ban *mention target* *reason(optional)*```")
    ...
    async def slashBan(self, interaction: discord.Interaction, user: Union[discord.Member, discord.User], reason : str = None):
    ...
    async def welcome(self, context):
        ...
        if(len(message.channel_mentions) > 0):
            ...
            await context.send("```" + context.prefix + "welcome *mention channel* *mention role(optional)*```")
    ...
    async def slashWelcome(self, interaction: discord.Interaction, channel : discord.TextChannel = None, role : discord.Role = None):
    ...
    async def slashAnnounce(self, interaction : discord.Interaction, channel : discord.TextChannel, message: str):
