...
class PokeCog(commands.Cog):
    ...
    async def slashPokeinfo(self, interaction: discord.Interaction, id: int = None, name: str = None):
    ...
    async def slashPokedex(self, interaction: discord.Interaction, user: discord.User = None, page: int = 1):
