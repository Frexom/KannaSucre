...
from moderationFunctions import *
...
class ModerationCog(commands.Cog):
    ...
    async def slashPrune(self, interaction: discord.Interaction, user: Union[discord.Member, discord.User]):
    ...
    async def slashKick(self, interaction:discord.Interaction, user: Union[discord.Member, discord.User], reason: str = None):
